...
namespace Hiweather
{
    public partial class Form_config_bak : Form
    {
        public Form_config_bak()
        {
            InitializeComponent();
        ...
        private void Form_config_Load(object sender, EventArgs e)
        {
            ...
            arrList.Add(new Item("label", 50, 10, "설정"));
        ...
        private Control Control_Create(Item item)
        {
            ...
            switch (item.getType())
            {
                ...
                case "search_button":
                    ...
                    System.Drawing.Image myImage = Image.FromFile("C:\\search_button_copy.png");
